-- Query necessaria para verificar o espaco no inicio e final do datafile, no qual pode causar erros na execucao do backup efetuado via ferramenta de terceiros sem ser pelo o sql server. 
Exemplo de ferramenta que apresenta erro Rubrik
